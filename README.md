...
This repository includes custom data collection and simulation scripts in the `robosuite/My_Sim/` directory:

### Data Collection Scripts
Located in `robosuite/My_Sim/data_collection/`:
- **Multi-camera setup**: `run_multicam.py` - Demonstrates 4-camera arrangement
- **Spiral orbit data collection**: `orbit_wiping_camera.py` - Panda robot with spiral motion
- **Baxter robot data collection**: `baxter_lift_spiral.py` - Baxter robot with larger workspace
- **Hemisphere scan**: `orbit_camera.py` - Comprehensive 3D coverage
- **Interactive simulation**: `panda_wiping_sim.py` - Interactive wiping task
- **Video creation**: `create_video.py` - Convert image sequences to videos

### How to Run Custom Scripts
```bash
# Run multi-camera demonstration
python3 robosuite/My_Sim/data_collection/run_multicam.py

# Collect spiral orbit dataset
python3 robosuite/My_Sim/data_collection/orbit_wiping_camera.py

# Interactive wiping simulation
python3 robosuite/My_Sim/data_collection/panda_wiping_sim.py
```

For detailed documentation of each script, see `robosuite/My_Sim/data_collection/README.md`.
